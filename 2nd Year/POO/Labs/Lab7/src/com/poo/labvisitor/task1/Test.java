...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        List<TextSegment> textSegments2 = new LinkedList<>();

        textSegments2.add(new ItalicTextSegment("Mecanismul din spatele pattern-ului "));

        WikiGenerator generator = new WikiGenerator(textSegments);
        WikiGenerator generator2 = new WikiGenerator(textSegments2);
        ...
        System.out.println(generator2.getDokuWikiDocument2());
    }
