...
public class Showroom {
    public static void main(String[] args) {
        ...
        Car car4 = dealership.getCar(Dealership.Mustang);
        Car car5 = dealership.getCar(Dealership.Ferrari);
        Car car7 = dealership.getCar((CarType.ELECTRIC_ANON));
        Car car6 = dealership.getCar(((CarType.ELECTRIC_LAMBDA)));
    }
}
