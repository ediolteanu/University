...
public final class Pyromancer extends Hero {
    public Pyromancer(final int id, final int row, final int col) {
        super(id, "Pyromancer", row, col, Constants.PYROMANCER_INITIAL_HP);
    }
    ...
    private int ignite(final Hero hero, final TerrainType terrainType, final float raceModifier) {
        ...
        damage = round(damage);
        damageOverTime = round(damageOverTime);
        ...
        damage = damage + damage * (sumModifiers);
        damageOverTime = damageOverTime + damageOverTime * (sumModifiers);
    ...
    public void applyStrategy() {
        if ((this.getCurrentHP() > Constants.STRATEGY_PYROMANCER_LOWER_PERCENT * this.getTotalHP())
                && (this.getCurrentHP()
                < Constants.STRATEGY_PYROMANCER_UPPER_PERCENT * this.getTotalHP())) {
            ...
            enoughHealthStrategy.applyPercentageHealthStrategy(this);
                ...
                < Constants.STRATEGY_PYROMANCER_LOWER_PERCENT * this.getTotalHP()) {
