...
HD_PWD='E:/Facultate/CN2/lab0/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log task01b_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source task01b_test.tcl -notrace
