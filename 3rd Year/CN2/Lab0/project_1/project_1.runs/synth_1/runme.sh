...
HD_PWD='E:/Facultate/CN2/lab0/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log task01b_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source task01b_test.tcl
